...
oname = os.getenv("FM_NAME")
opass = os.getenv("FM_PASS")
...
async def main():  # Added async here
    ...
    async with async_playwright() as p:
        ...
        await page.get_by_role("textbox", name="Enter your email, phone, or").fill(oname)
        await page.get_by_role("button", name="Next").click()
        await page.get_by_role("textbox", name="Enter the password for").click()
        await page.get_by_role("textbox", name="Enter the password for").fill(opass)
